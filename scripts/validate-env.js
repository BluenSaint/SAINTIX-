...
function generateEnvTemplates() {
  ...
  Object.entries(templates).forEach(([filename, config]) => {
    const content = [
      ...
      `# Generated automatically by validate-env.js`,
      '',
...
function main() {
  ...
  if (args.includes('--help') || args.includes('-h')) {
    ...
    console.log('  node scripts/validate-env.js                 Validate environment variables');
    console.log('  node scripts/validate-env.js --generate-templates  Generate .env template files');
    console.log('  node scripts/validate-env.js --help         Show this help message');
    console.log('');
    return;
  }
